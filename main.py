...
def change_volume(val):
    volume = int(val) / 100  # Volume scale 0 to 1
    pygame.mixer.music.set_volume(volume)
    volume_label.config(text=f"Volume: {int(val)}%")  # Update the volume label text
...
# Load resized icons (manually resized images)
play_icon = tk.PhotoImage(file="play_icon.png")  # Replace with your resized file path
pause_icon = tk.PhotoImage(file="pause_icon.png")  # Replace with your resized file path
stop_icon = tk.PhotoImage(file="stop_icon.png")  # Replace with your resized file path
