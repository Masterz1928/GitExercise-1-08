...
def main_api():
    ...
    Upload_Option.title("File Uploader")

    file_listbox = tk.Listbox(Upload_Option, height=10)
...
btn_upload = tk.Button(button_frame, text="Connect to Drive", font=25, relief="flat", width=20, height=3, command=lambda: threaded_authenticate(main_api))
